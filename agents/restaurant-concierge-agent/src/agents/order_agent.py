...
- "chai" → "Masala Chai"
- Handle plurals: "2 biryani" = 2x Chicken Biryani
...
"""
    ...
    def _find_best_menu_match(self, item_name: str) -> Optional[Dict[str, Any]]:
        ...
        intelligent_matches = {
            ...
            "sprout chaat": "Sprout Chaat Salad",
            "chai": "Masala Chai",
            "tea": "Masala Chai",
            "lassi": "Mango Lassi",
    ...
    def handle_order_modification(self, customer_input: str) -> str:
        ...
        # Patterns for removal like: remove 1 biryani, remove the biryani, delete dosa, take off 2 chai
        removal_patterns = [
        ...
        # Pattern for quantity set: make that 2 biryani, change dosa to 3
        qty_set_patterns = [
...
- Remove items: "remove the biryani", "take off the dosa"
- Change quantities: "make that 2 biryani instead of 1"
- Add customizations: "make the biryani extra spicy"
- Replace items: "change dosa to paneer tikka"
